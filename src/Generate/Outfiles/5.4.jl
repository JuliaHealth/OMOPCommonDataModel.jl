...
Base.@kwdef struct VisitOccurrence <: CDMType
    ...
    admitted_from_concept_id::Union{Int, Missing} = missing # optional
    admitted_from_source_value::Union{String, Missing} = missing # optional
    discharged_to_concept_id::Union{Int, Missing} = missing # optional
    discharged_to_source_value::Union{String, Missing} = missing # optional
...
Base.@kwdef struct VisitDetail <: CDMType
    ...
    parent_visit_detail_id::Union{Int, Missing} = missing # optional
    visit_occurrence_id::Int # required
end
...
Base.@kwdef struct ProcedureOccurrence <: CDMType
    ...
    procedure_end_date::Union{Dates.DateTime, Missing} = missing # optional
    procedure_end_datetime::Union{Dates.DateTime, Missing} = missing # optional
...
Base.@kwdef struct DeviceExposure <: CDMType
    ...
    production_id::Union{String, Missing} = missing # optional
    quantity::Union{Int, Missing} = missing # optional
    provider_id::Union{Int, Missing} = missing # optional
    visit_occurrence_id::Union{Int, Missing} = missing # optional
    visit_detail_id::Union{Int, Missing} = missing # optional
    ...
    unit_source_concept_id::Union{Int, Missing} = missing # optional
end
...
Base.@kwdef struct Measurement <: CDMType
    ...
    measurement_event_id::Union{Int, Missing} = missing # optional
    meas_event_field_concept_id::Union{Int, Missing} = missing # optional
end
...
Base.@kwdef struct Observation <: CDMType
    ...
    value_source_value::Union{String, Missing} = missing # optional
    observation_event_id::Union{Int, Missing} = missing # optional
    obs_event_field_concept_id::Union{Int, Missing} = missing # optional
end
...
Base.@kwdef struct Note <: CDMType
    ...
    note_event_id::Union{Int, Missing} = missing # optional
    note_event_field_concept_id::Union{Int, Missing} = missing # optional
end
...
Base.@kwdef struct Location <: CDMType
    ...
    country_concept_id::Union{Int, Missing} = missing # optional
    country_source_value::Union{String, Missing} = missing # optional
    latitude::Union{Float64, Missing} = missing # optional
    longitude::Union{Float64, Missing} = missing # optional
end
...
Julia struct name: Episode

$(DocStringExtensions.TYPEDEF)
$(DocStringExtensions.TYPEDFIELDS)
"""
Base.@kwdef struct Episode <: CDMType
    episode_id::Int # required
    person_id::Int # required
    episode_concept_id::Int # required
    episode_start_date::Dates.DateTime # required
    episode_start_datetime::Union{Dates.DateTime, Missing} = missing # optional
    episode_end_date::Union{Dates.DateTime, Missing} = missing # optional
    episode_end_datetime::Union{Dates.DateTime, Missing} = missing # optional
    episode_parent_id::Union{Int, Missing} = missing # optional
    episode_number::Union{Int, Missing} = missing # optional
    episode_object_concept_id::Int # required
    episode_type_concept_id::Int # required
    episode_source_value::Union{String, Missing} = missing # optional
    episode_source_concept_id::Union{Int, Missing} = missing # optional
end
...
"""
CDM table name: EPISODE_EVENT

Julia struct name: EpisodeEvent

$(DocStringExtensions.TYPEDEF)
$(DocStringExtensions.TYPEDFIELDS)
"""
Base.@kwdef struct EpisodeEvent <: CDMType
    episode_id::Int # required
    event_id::Int # required
    episode_event_field_concept_id::Int # required
end
...
Base.@kwdef struct CdmSource <: CDMType
    ...
    cdm_source_abbreviation::String # required
    cdm_holder::String # required
    ...
    source_release_date::Dates.DateTime # required
    cdm_release_date::Dates.DateTime # required
    cdm_version::Union{String, Missing} = missing # optional
    cdm_version_concept_id::Int # required
...
Base.@kwdef struct Vocabulary <: CDMType
    ...
    vocabulary_reference::Union{String, Missing} = missing # optional
